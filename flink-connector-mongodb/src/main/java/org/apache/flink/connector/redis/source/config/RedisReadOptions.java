...
package org.apache.flink.connector.redis.source.config;
...
public class RedisReadOptions implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        RedisReadOptions that = (RedisReadOptions) o;
        return partitionStrategy == that.partitionStrategy
    ...
    /** Builder for {@link RedisReadOptions}. */
    @PublicEvolving
    public static class MongoReadOptionsBuilder {
        private int fetchSize = 2048;
        private boolean noCursorTimeout = true;
        private PartitionStrategy partitionStrategy = PartitionStrategy.DEFAULT;
        private MemorySize partitionSize = MemorySize.parse("64mb");
        private int samplesPerPartition = 10;
        ...
        /**
         * Build the {@link RedisReadOptions}.
         *
