...
/**
 * A split reader implements {@link SplitReader} for {@link RedisSourceSplit}.
 *
 * @param <T> Redis source split.
 */
@Internal
public interface RedisSourceSplitReader<T extends RedisSourceSplit>
        extends SplitReader<RedisHash, T> {}